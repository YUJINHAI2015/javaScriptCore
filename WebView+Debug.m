...
-(id)functionNameForFrame:(WebScriptCallFrame*)frame; // 获得方法名
-(id)callerForFrame:(WebScriptCallFrame*)frame; // 调用方法
-(id)exceptionForFrame:(WebScriptCallFrame*)frame;// 异常方法
